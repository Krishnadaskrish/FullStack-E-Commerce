...
AdminRouter.patch('/products/:id',verifyToken,TryCatch(AdminController.updateProduct))
AdminRouter.delete('/products/:id',verifyToken,TryCatch(AdminController.deleteProduct))
